...
in
  mkIf cfg.enable {
    virtualisation.oci-containers.containers.${cfg.app.containerName}.environment =
      {
        ...
        # Set to true if you want to see debug information in error
        # screens.
        APP_DEBUG = "false";
        ...
        # your logs will grow large, and fast. If you set it to emergency probably
        # nothing will get logged, ever.
        APP_LOG_LEVEL = "notice";

        # Audit log level. The audit log is used to log notable Firefly III events on
        # a separate channel. These log entries may contain sensitive financial information. The audit log is disabled by default.
        #
        # To enable it, set AUDIT_LOG_LEVEL to "info" To disable it, set
        # AUDIT_LOG_LEVEL to "emergency"
        AUDIT_LOG_LEVEL = "emergency";

        #
        # If you want, you can redirect the audit logs to another channel. Set
        # 'audit_stdout', 'audit_syslog', 'audit_errorlog' to log to the system itself. Use audit_daily to log to a rotating file. Use audit_papertrail to log to papertrail.
        #
        # If you do this, the audit logs may be mixed with normal logs because the
        # settings for these channels are often the same as the settings for the
        # normal logs.
        AUDIT_LOG_CHANNEL = "";

        #
        # Used when logging to papertrail: Also used when audit logs log to
        # papertrail:
        #
        PAPERTRAIL_HOST = "";
        PAPERTRAIL_PORT = "";
        ...
        # MySQL supports SSL. You can configure it here. If you use Docker or similar,
        # you can set these variables from a file by appending them with _FILE
        MYSQL_USE_SSL = "false";
        MYSQL_SSL_VERIFY_SERVER_CERT = "true";
        # You need to set at least of these
        # options
        ...
        # PostgreSQL supports SSL. You can configure it here. If you use Docker or
        # similar, you can set these variables from a file by appending them with _FILE
        ...
        # If you set either of the options above to 'redis', you might want to update
        # these settings too If you use Docker or similar, you can set REDIS_HOST_FILE, REDIS_PASSWORD_FILE or REDIS_PORT_FILE to set the value from a file instead of from an environment variable

        # can be tcp, unix or
        # http
        REDIS_SCHEME = "tcp";

        # use only when using 'unix' for REDIS_SCHEME. Leave empty
        # otherwise.
        REDIS_PATH = "";

        # use only when using 'tcp' or 'http' for REDIS_SCHEME. Leave empty
        # otherwise.
        REDIS_HOST = "127.0.0.1";
        REDIS_PORT = "6379";

        # Use only with Redis 6+ with proper ACL set. Leave empty
        # otherwise.
        REDIS_USERNAME = "";
        REDIS_PASSWORD = "";
        ...
        # If you want Firefly III to email you, update these settings For
        # instructions, see: https://docs.firefly-iii.org/firefly-iii/advanced-installation/email/#email If you use Docker or similar, you can set these variables from a file by appending them with _FILE
        MAIL_MAILER = "log";
        MAIL_HOST = "null";
        MAIL_PORT = "2525";
        ...
        # Other mail drivers: If you use Docker or similar, you can set these
        # variables from a file by appending them with _FILE
        MAILGUN_DOMAIN = "";
        MAILGUN_SECRET = "";

        # If you are on EU region in mailgun, use api.eu.mailgun.net, otherwise use
        # api.mailgun.net If you use Docker or similar, you can set this variable from
        # a file by appending it with _FILE
        MAILGUN_ENDPOINT = "api.mailgun.net";

        # If you use Docker or similar, you can set these variables from a file by
        # appending them with _FILE
        MANDRILL_SECRET = "";
        SPARKPOST_SECRET = "";
        ...
        # These messages contain (sensitive) transaction
        # information:
        SEND_REPORT_JOURNALS = "true";

        # Set this value to true if you want to set the location of certain things,
        # like transactions. Since this involves an external service, it's optional
        # and disabled by default.
        ENABLE_EXTERNAL_MAP = "false";

        # Set this value to true if you want Firefly III to download currency exchange
        # rates from the internet. These rates are hosted by the creator of Firefly
        # III inside an Azure Storage Container. Not all currencies may be available.
        # Rates may be wrong.
        ENABLE_EXTERNAL_RATES = "false";

        # The map will default to this
        # location:
        ...
        #
        # Some objects have room for an URL, like transactions and webhooks. By
        # default, the following protocols are allowed: http, https, ftp, ftps, mailto
        #
        # To change this, set your preferred comma separated set below. Be sure to
        # include http, https and other default ones if you need to.
        #
        VALID_URL_PROTOCOLS = "";
        ...
        #
        # Firefly III generates a basic keypair for your OAuth tokens. If you want,
        # you can overrule the key with your own (secure) value. It's also possible to
        # set PASSPORT_PUBLIC_KEY_FILE or PASSPORT_PRIVATE_KEY_FILE if you're using
        # Docker secrets or similar solutions for secret management
        #
        ...
        #
        # The static cron job token can be useful when you use Docker and wish to
        # manage cron jobs. 1. Set this token to any 32-character value (this is
        # important!). 2. Use this token in the cron URL instead of a user's command
        # line token that you can find in /profile
        #
        # For more info:
        ...
        # and features may result in lots of inconsistent data. However if you know
        # what you're doing you can significantly speed up container start times. Set
        # each value to true to enable, or false to disable.

        # Set this to true to build all locales supported by Firefly III. This may
        # take quite some time (several minutes) and is generally not recommended. If
        # you wish to change or alter the list of locales, start your Docker container
        # with `docker run -v locale.gen:/etc/locale.gen -e DKR_BUILD_LOCALE = "true`";
        ...
        # Run database reporting commands. When disabled, Firefly III won't go over
        # your data to report current state. Disabling this should have no impact on
        # data integrity or safety but it won't warn you of possible issues.
        DKR_RUN_REPORT = "true";

        # Generate OAuth2 keys. When disabled, Firefly III won't attempt to generate
        # OAuth2 Passport keys. This won't be an issue, IFF (if and only if) you had
        ...
        #
        # If you have trouble configuring your Firefly III installation, DON'T BOTHER
        # setting this variable. It won't work. It doesn't do ANYTHING. Don't believe
        # the lies you read online. I'm not joking. This configuration value WILL NOT HELP.
        #
        # Notable exception to this rule is Synology, which, according to some users,
        # will use APP_URL to rewrite stuff.
        #
        ...
        # do anything. Nothing
        #
        # If you're stuck I understand you get desperate but look SOMEWHERE
        # ELSE.
        #
        APP_URL = "http://localhost";
      }
      // cfg.app.extraEnvironmentVars;
  }
